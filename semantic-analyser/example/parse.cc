// Generated by Bisonc++ V4.05.00 on Wed, 11 Feb 2015 14:45:04 +0530
...
PI__ const s_productionInfo[] = 
{
     ...
     {265, 3}, // 1: statement ('=') ->  lhs '=' term
     {266, 2}, // 2: lhs ->  unop lhs
     {266, 1}, // 3: lhs (id) ->  id
     {267, 3}, // 4: term ('*') ->  term '*' factor
     {267, 1}, // 5: term ->  factor
     {268, 1}, // 6: factor (intconst) ->  intconst
     {268, 1}, // 7: factor (floatconst) ->  floatconst
     {268, 3}, // 8: factor ('(') ->  '(' term ')'
     {268, 2}, // 9: factor ->  unop factor
     {268, 1}, // 10: factor (id) ->  id
     {269, 1}, // 11: unop ('-') ->  '-'
     {269, 1}, // 12: unop ('*') ->  '*'
     {270, 1}, // 13: statement_$ ->  statement
};
...
SMapVal s_symArr[] =
{
    ...
    SMapVal(257, "id"),
    SMapVal(258, "intconst"),
    SMapVal(259, "floatconst"),
    SMapVal(265, "statement"),
    SMapVal(266, "lhs"),
    SMapVal(267, "term"),
    SMapVal(268, "factor"),
    SMapVal(269, "unop"),
    SMapVal(270, "statement_$"),
};
...
#line 13 "parse.y"
        {
         (d_vsp__[-2].data<Tag__::typeAttr>()).Type::printType();
         (d_vsp__[0].data<Tag__::typeAttr>()).Type::printType();
         if ((d_vsp__[-2].data<Tag__::typeAttr>()).tag == Type::Error || 
         (d_vsp__[0].data<Tag__::typeAttr>()).tag == Type::Error)
         d_val__.get<Tag__::typeAttr>() = Type(Type::Error);
         else if (compatible (d_vsp__[-2].data<Tag__::typeAttr>(), d_vsp__[0].data<Tag__::typeAttr>())) 
         d_val__.get<Tag__::typeAttr>() = Type(Type::Ok);
         else d_val__.get<Tag__::typeAttr>() = Type(Type::Error);
         (d_val__.get<Tag__::typeAttr>()).Type::printType();}
        break;
...
#line 30 "parse.y"
        { 
         (d_vsp__[0].data<Tag__::typeAttr>()).Type::printType();
         if ((d_vsp__[0].data<Tag__::typeAttr>()).tag == Type::Error) 
         d_val__.get<Tag__::typeAttr>() = Type(Type::Error);
         else if ((d_vsp__[0].data<Tag__::typeAttr>()).tag == Type::Pointer)
         d_val__.get<Tag__::typeAttr>() = *(d_vsp__[0].data<Tag__::typeAttr>()).pointed;
         else d_val__.get<Tag__::typeAttr>() = Type(Type::Error);
...
#line 44 "parse.y"
        {
         ...
         d_val__.get<Tag__::typeAttr>() = Symboltable[d_vsp__[0].data<Tag__::idAttr>()];
         std::cout << d_vsp__[0].data<Tag__::idAttr>() << std::endl;
...
#line 55 "parse.y"
        {
         ...
         (d_vsp__[0].data<Tag__::typeAttr>()).tag == Type::Error)
         d_val__.get<Tag__::typeAttr>() = Type(Type::Error);
         else if ((d_vsp__[-2].data<Tag__::typeAttr>()).tag == Type::Pointer || 
         (d_vsp__[0].data<Tag__::typeAttr>()).tag == Type::Pointer)
         d_val__.get<Tag__::typeAttr>() = Type(Type::Error);
         else if ((d_vsp__[-2].data<Tag__::typeAttr>()).basetype == Type::Int && 
         (d_vsp__[0].data<Tag__::typeAttr>()).basetype == Type::Int)
         d_val__.get<Tag__::typeAttr>() = Type(Type::Base, Type::Int);
         else d_val__.get<Tag__::typeAttr>() = Type(Type::Base, Type::Float);
         (d_val__.get<Tag__::typeAttr>()).Type::printType();
         }
        break;
...
#line 95 "parse.y"
        {
         d_val__.get<Tag__::typeAttr>()= Type(Type::Base, Type::Float);
...
#line 102 "parse.y"
        {
         (d_vsp__[-1].data<Tag__::typeAttr>()).Type::printType();
